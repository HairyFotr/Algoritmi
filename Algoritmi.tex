...
\lstinputlisting[title={Binarno drevo}]{./src/binarytree.py}
\section{Ulomki}
\lstinputlisting[title={Ulomki}]{./src/fractions.py}
...
\end{comment}
\lstinputlisting[title={Preprosti algoritem za preverjanje praštevilskosti}]{./src/prime.py}
...
\end{comment}
\lstinputlisting[title={Evklidov algoritem za iskanje največjega skupnega delitelja}]{./src/GCD.py}
...
\end{comment}
\lstinputlisting[title={Algoritem za izračun $n$-tega števila Fibonaccijevega zaporedja}]{./src/fib.py}
...
\end{comment}
\lstinputlisting[title={Algoritem binarnega iskanja oz. bisekcije v urejeni tabeli}]{./src/binarysearch.py}
...
\lstinputlisting[language=GNUplot, firstnumber=0, title={Psevdokoda Ford-Fulkersonovega algoritma za iskanje maksimalnega pretoka skozi graf}]{./src/maxFlow.txt}
...
\end{comment}
\lstinputlisting[language=GNUplot, firstnumber=0, title={Psevdokoda algoritma za topološko urejanje grafa}]{./src/topologicalSorting.txt}
...
\end{comment}
\lstinputlisting[language=GNUplot, firstnumber=0, title={Psevdokoda Dijkstovega algoritma za iskanje najcenejših poti}]{./src/Dijkstra.txt}
\begin{comment}
...
\lstinputlisting[title={Algoritem za reševanje linearnih enačb}]{./src/solve.py}
